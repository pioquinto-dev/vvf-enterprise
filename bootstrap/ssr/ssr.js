...
function MiniStepper({ current }) {
	const activeIdx = STEPS$1.findIndex((s) => s.key === current);
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: [{
			...
			const stateIdx = i === 0 ? 0 : STEPS$1.findIndex((x) => x.key === s.key) + 1;
	...
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx("style", { children: `
      ...
      ` }), /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			state === "sources" && /* @__PURE__ */ jsxs("div", { children: [
				/* @__PURE__ */ jsxs("div", {
					className: "ph",
					children: [
						/* @__PURE__ */ jsx("p", {
...
function SearchListScreen({ kind = "brand", searches = [], moving = [], suggestions = [] }) {
	...
	return /* @__PURE__ */ jsxs(AppLayout, {
		...
		children: [
			kind === "brand" ? /* @__PURE__ */ jsx(BrandInlineFlow, {
				kind: "brand",
