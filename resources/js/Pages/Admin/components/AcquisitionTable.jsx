...
export default function AcquisitionTable({ acquisition = {} }) {
    ...
    return <section className="min-w-0 rounded-2xl border border-[#dce4f0] bg-white p-4 sm:p-5">
        ...
        <details className="mt-3 text-xs text-slate-500"><summary className="cursor-pointer">How these numbers are counted</summary>
            ...
            <p className="mt-2">Direct means no UTM source was captured on this signup's attribution. Missing medium and campaign values are hidden from user rows. No campaign recorded groups signups without a campaign tag. Paid and organic traffic are not inferred beyond that. Program membership is separate from acquisition source.</p>
        </details>
