    ...
    public function editableFields(string $resource): array
    {
        return match ($resource) {
            ...
            'plans' => [
                ...
                ['name' => 'bookmark_limit', 'label' => 'Bookmark limit', 'type' => 'number', 'help' => 'Stored in plan metadata.'],
    ...
    public function editValues(string $resource, Model $record): array
    {
        return match ($resource) {
            ...
            'plans' => [
                ...
                'search_credits_limit' => (int) data_get($record->metadata, 'searchCreditsLimit', 0),
                'bookmark_limit' => (int) data_get($record->metadata, 'bookmarkLimit', 0),
            ...
            'subscription' => [
                ...
                'search_credits_limit' => (int) data_get($record->plan?->metadata, 'searchCreditsLimit', 0),
                'bookmark_limit' => (int) data_get($record->plan?->metadata, 'bookmarkLimit', 0),
